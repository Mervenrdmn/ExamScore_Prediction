...
## 📂 Project Structure
Haklısın, mevcut hali biraz dağınık ve göze hoş görünmüyor. Sana daha temiz, okunabilir ve profesyonel bir README yapısı hazırladım. Özellikle Project Structure kısmını düzenledim, hiyerarşiyi netleştirdim ve açıklamaları hizaladım. İşte tek kod bloğu halinde final versiyon:
# Exam Score Prediction 📊
